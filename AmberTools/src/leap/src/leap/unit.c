 ...
 */
void
UnitSaveAmberParmFile( UNIT uUnit, FILE *fOut, FILE *fCrd, 
        PARMLIB plParms, BOOL bPolar, BOOL bPert )
{
        BOOL            bGeneratedParameters;
        ...
        if ( bGeneratedParameters == TRUE ) {
                if( GDefaults.iOldPrmtopFormat ) 
                        zUnitIOSaveAmberParmFormat_old( uUnit, fOut, fCrd, 
                                                                bPolar, bPert );
                else 
                        zUnitIOSaveAmberParmFormat( uUnit, fOut, fCrd, 
                                                                bPolar, bPert );
        } else {
