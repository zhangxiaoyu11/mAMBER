...
# MdoutAnalyzer.py
sed -e "s@PYTHONEXE@$2@g" < MdoutAnalyzer.py > $1/MdoutAnalyzer.py
/bin/chmod +x $1/MdoutAnalyzer.py

# remake_cpouts.py
sed -e "s@PYTHONEXE@$2@g" < remake_cpouts.py > $1/remake_cpouts.py
/bin/chmod +x $1/remake_cpouts.py
