 ...
 *   $Header: /home/case/cvsroot/amber11/AmberTools/src/netcdf/src/ncgen/main.c,v 9.2 2009/09/11 17:48:29 bproberts Exp $
 *********************************************************************/

#include <config.h>
#include <stdio.h>		/* has getopt() under VMS */
#include <unistd.h>		/* has getopt() under some other systems */
#include <string.h>
