...
parser.add_argument("-ix", help="Propagation performed along crystal a-vector")
parser.add_argument("-iy", help="Propagation performed along crystal b-vector")
parser.add_argument("-iz", help="Propagation performed along crystal c-vector")
