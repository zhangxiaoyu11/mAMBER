...
WORKING_DIR=/home/pjanowsk/Case/4lzt/RunSi/1.5ms_analysis

#  Amber files for the supercell (might have waters, etc stripped):
SC_PRMTOP=/home/pjanowsk/Case/4lzt/RunSi/4lztSc_nowat.prmtop            # supercell topology
SC_RST7=/home/pjanowsk/Case/4lzt/RunSi/4lztSc_centonpdb_nowat.rst7                 # supercell with pdb (experimental) coords.
SC_TRAJECTORY=/home/pjanowsk/Case/4lzt/RunSi/ptraj/merge_nowat.nc       # trajectory to be analyzed

#  Amber files for the asymmetric unit:
ASU_RST7=/home/pjanowsk/Case/4lzt/RunSi/4lztUC.rst7                  # same coordinates as pdb!
ASU_PRMTOP=/home/pjanowsk/Case/4lzt/RunSi/4lztUC.prmtop 
ASU_PDB=/home/pjanowsk/Case/4lzt/RunSi/4lztUC.pdb                    # must contain SMTRY and CRYST1 records 
                                   # from original pdb

#   Information on how the supercell was constructed
PROP=(3 2 2)          # Propagation operations used to build supercell (a, b, c)
ASUS=1                # Number of ASU's in unit cell
UNITCELLS=12           # Number of unit cells in the supercell
RESIDUES=139          # Number of residues in the (stripped) ASU
PLOT_PFX="4lzt_Si"      # filename prefix (for plots, etc.)
...
BM2=":1-129&!(@H=,CA,C,O,N)"              # B factor sidechain mask
RM1=":3-127&!(@H=)"              # RMSD heavy atom mask (also used for 
                                 #   RotFit B-factor calculation
RM2=":3-127@CA,C,N"              # RMSD backbone atom mask
Timestep=0.2   	             # Timestep for rmsd output
BFAC_CRYST_CALPHA=/home/pjanowsk/Case/4lzt/RunSi/1.5ms_analysis/bfac_crystal_calpha.dat 
BFAC_CRYST_SDCH=/home/pjanowsk/Case/4lzt/RunSi/1.5ms_analysis/bfac_crystal_residue.dat
