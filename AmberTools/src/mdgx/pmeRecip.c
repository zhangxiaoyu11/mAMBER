...
/***   crd:     the coordinates, needed to see how large the box is        ***/
/***=======================================================================***/
...
/***=======================================================================***/
/*** GammSum: this function computes a quantity needed for the B mesh      ***/
...
double* LoadPrefac(int ordr, int ng)
{
  ...
  /*** Allocate memory ***/
  bsparr = (double*)calloc(ng, sizeof(double));
