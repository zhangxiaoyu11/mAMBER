...
void PrintUsage()
{
  ...
  printf("  -INPUT:   print all command line input options\n"
	 ...
	 "            be entered as command line input)\n"
         ...
         "  -FIT:     print &fit (charge fitting) namelist variables\n"
...
void PrintFitNamelistVariables()
{
  ...
  PrintVADesc(1, "phi#", 11, "QMPhi#", 14, "Names of additional electrostatic "
	      ...
	      "which is expected to match the atoms found in the prmtop.", 54,
	      2, stdout);
  ...
  PrintVADesc(1, "phiwt#", 11, "PhiWeight#", 14, "The weights assigned to "
	      ...
	      "electrostatic potential it implies, in the fit.", 54, 2,
	      stdout);
...
void PrintParamNamelistVariables()
{
  ...
  PrintVADesc(1, "fitscee", 11, "FitEE14", 14, "Requests a linear "
	      ...
	      54, 2, stdout);
  PrintVADesc(1, "ReportAll", 11, "repall", 14, "Flag to activate output "
  ...
  PrintVADesc(1, "ctol", 11 ,"ConfTol", 14, "Tolerance for deviation from the "
	      "mean energy value, specified as a function of the standard "
  ...
  PrintVADesc(1, "eunits", 11, "EnergyUnits", 14, "Units of the target energy "
	      "values.  Default Hartrees.  Acceptable values include Hartree/"
  ...
  PrintVADesc(1, "hrst", 11 ,"DiehdralRest", 14, "General value for harmonic "
